...
export const metadata = {
  title: 'Graphing',
  description: 'Covers how to use the Log Analyzer window, how to add and remove graphs, how to define graph templates, and how to zoom in on sections of the graph.'
}
  ...
  return (
    <div className='w-full gap-4 py-4 pl-7 pr-4 xl:pl-4'>
      ...
      <div className='m-10 mx-auto flex max-w-screen-lg flex-col gap-4 rounded-md border border-gray-300 p-4 shadow-lg shadow-primary/20'>
        ...
        <Image className='w-full lg:w-3/4' src={GraphingNEW} alt='Log Analyzer' />
      </div>
      <div className='m-10 mx-auto flex max-w-screen-lg flex-col gap-4 rounded-md border border-gray-300 p-4 shadow-lg shadow-primary/20'>
        ...
        <Image className='w-full lg:w-3/4' src={Graphing2} alt='Graph Template' />
      </div>
      <div className='m-10 mx-auto flex max-w-screen-lg flex-col gap-4 rounded-md border border-gray-300 p-4 shadow-lg shadow-primary/20'>
